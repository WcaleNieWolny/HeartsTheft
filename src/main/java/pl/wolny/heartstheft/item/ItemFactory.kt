            ...
            lore(
                listOf(
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<red>Mityczny przedmiot prosto z serca boga wojny!"))
                )
            )
            displayName(
                Component.empty().decoration(TextDecoration.ITALIC, false).append(formatMessage("<#e31b4a>SERCE ARESA"))
            ) //EROSA
    ...
    fun liveSpawner(): ItemStack {
        ...
        with(meta) {
            lore(
                listOf(
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<green>Przywróci każdego z grobu!")),
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<green>Napisz do administracji aby użyć ;)")),
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<green>Czas odpowiedzi wynosi do 48 godzin"))
                )
            )
            displayName(
                Component.empty().decoration(TextDecoration.ITALIC, false)
                    .append(formatMessage("<#14d746>SPAWNER DIONIZOUSA"))
            ) //<#14d746cc>
            addEnchant(Enchantment.THORNS, 1, true)
            addItemFlags(ItemFlag.HIDE_ENCHANTS)
        }
    ...
    fun upgradedNetherite(ammount: Int = 1): ItemStack {
        ...
        with(meta) {
            lore(
                listOf(
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<light_purple>Magiczna sztabka boga kowali!")),
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<light_purple>Używana do ulepszania zbroi")),
                )
            )
            displayName(
                Component.empty().decoration(TextDecoration.ITALIC, false)
    ...
    fun upgradedNetheriteBlock(): ItemStack {
        ...
        with(meta) {
            lore(
                listOf(
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<light_purple>Magiczny blok boga kowali!"))
                )
            )
            displayName(
                Component.empty().decoration(TextDecoration.ITALIC, false)
    ...
    fun elytraItem(): ItemStack {
        ...
        with(meta) {
            lore(
                listOf(
                    Component.empty().decoration(TextDecoration.ITALIC, false)
                        .append(formatMessage("<light_purple>Skrzydła prosto z greckiego boga złodzei!")),
                )
            )
            displayName(
                Component.empty().decoration(TextDecoration.ITALIC, false)
